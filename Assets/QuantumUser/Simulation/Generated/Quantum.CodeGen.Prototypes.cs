...
namespace Quantum.Prototypes {
  ...
  [Quantum.Prototypes.Prototype(typeof(Quantum.FinishZone))]
  public unsafe partial class FinishZonePrototype : ComponentPrototype<Quantum.FinishZone> {
    [HideInInspector()]
    public Int32 _empty_prototype_dummy_field_;
    partial void MaterializeUser(Frame frame, ref Quantum.FinishZone result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.FinishZone component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref Quantum.FinishZone result, in PrototypeMaterializationContext context = default) {
  ...
  public unsafe partial class InputPrototype : StructPrototype {
    ...
    public void Materialize(Frame frame, ref Quantum.Input result, in PrototypeMaterializationContext context = default) {
        ...
        result.Backwards = this.Backwards;
